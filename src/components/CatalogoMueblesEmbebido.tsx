...
interface CatalogoMueblesEmbebidoProps {
  urlCotizador?: string;
  altura?: string;
  className?: string;
}

const CatalogoMueblesEmbebido = ({
  urlCotizador = 'https://cotizador-app-two.vercel.app/muebles-publico',
  altura = '800px',
  className = ''
}: CatalogoMueblesEmbebidoProps) => {
  ...
  return (
    ...
    >
      <iframe
        src={urlCotizador}
        title="Catálogo de Muebles - Cotizador Interactivo"
        width="100%"
        height="100%"
        frameBorder="0"
        allowFullScreen
...
export default CatalogoMueblesEmbebido;
